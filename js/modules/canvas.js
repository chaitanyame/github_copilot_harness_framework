...
function handleStateChange(event, data) {
  switch (event) {
    case 'templateSelected':
      // For scene-based templates, we use previewUrl as the template background
      // But the actual composite is generated by Processor.generateSelfiePull()
      if (data.previewUrl) {
        loadTemplateImage(data.previewUrl);
      }
      break;
